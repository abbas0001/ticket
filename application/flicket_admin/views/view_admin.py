...
def users(page=1):
    ...
    # noinspection PyUnresolvedReferences
    return render_template('admin_users.html', title='کاربران', users=users)
...
def add_user():
    ...
    # noinspection PyUnresolvedReferences
    return render_template('admin_user.html', title='اضافه کردن کاربر', form=form)
...
def delete_user():
    ...
    # noinspection PyUnresolvedReferences
    return render_template('admin_delete_user.html', title='حذف کاربر',
...
def groups():
    ...
    # noinspection PyUnresolvedReferences
    return render_template('admin_groups.html', title='گروه ها', form=form, groups=groups)
...
def admin_edit_group():
    ...
    # noinspection PyUnresolvedReferences
    return render_template('admin_edit_group.html', title='ویرایش گروه', form=form)
