...
class CreateTicketForm(FlaskForm):
    ...
    hours = DecimalField(lazy_gettext('ساعت ها'), default=0)
    submit = SubmitField(lazy_gettext('ارسال'), render_kw=form_class_button, validators=[DataRequired()])
...
class SearchUserForm(FlaskForm):
    ...
    submit = SubmitField(lazy_gettext('جستجو'), render_kw=form_class_button)
...
class DepartmentForm(FlaskForm):
    ...
    submit = SubmitField(lazy_gettext('اضافه کردن دپارتمان'), render_kw=form_class_button)
